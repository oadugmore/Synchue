...
public class ScreenshotUtil : EditorWindow
{
    ...
    public void CaptureScreenshot()
    {
        ...
        ScreenCapture.CaptureScreenshot(outputPath, screenshotScale);
    }
    ...
    private void OnGUI()
    {
        ...
        //     screenshotNumber++;
        // }
        if (GUILayout.Button("Take all App Store screenshots"))
        {
            EditorCoroutineUtility.StartCoroutine(TakeAppStoreScreenshots(), this);
        }
    }
